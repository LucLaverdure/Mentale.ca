...
$( document.body ).on( 'added_to_cart', function( e ) {
  ...
  var productgallery = {
      ...
      if( $('.mfn-product-gallery').length ){
        ...
        $('.woocommerce-product-gallery').imagesLoaded( function() {
          if( $('.mfn-thumbnails-left').length || $('.mfn-thumbnails-right').length ){
            setTimeout(function() { productgallery.verticalThumbs(); }, 300);
    ...
    verticalThumbs: function() {
        ...
        if( $('.woocommerce-product-gallery__image.flex-active-slide').length )
            $('.mfn-product-gallery .flex-viewport').css({'height': $('.woocommerce-product-gallery__image.flex-active-slide').height() });
